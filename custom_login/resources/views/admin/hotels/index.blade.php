        ...
        <main class="flex-1 p-6 md:p-10 overflow-y-auto">
            <div class="max-w-7xl mx-auto space-y-10">
                ...
                <header class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 class="text-3xl font-black text-gray-900 dark:text-white tracking-tight">Hotel <span
                                class="text-indigo-600">Inventory</span></h1>
                        <p class="text-gray-500 dark:text-gray-400 font-medium mt-1">Manage partner hotels and
                            accommodations.</p>
                    </div>
                    <button
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition">
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            <div class="flex items-center gap-1 text-yellow-500">
                                                ...
                                                <span
                                                    class="font-bold text-gray-900 dark:text-white">{{ $hotel->rating }}</span>
                                            </div>
                                        </td>
