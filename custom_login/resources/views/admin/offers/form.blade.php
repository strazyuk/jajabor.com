        ...
        <main class="flex-1 p-6 md:p-10 overflow-y-auto">
            <div class="max-w-4xl mx-auto space-y-10">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 dark:text-gray-400 font-medium mt-1">
                                {{ isset($offer) ? 'Update promotional offer details.' : 'Add a new promotional banner.' }}
                            </p>
                        </div>
                    </div>
                </header>
                ...
                <div
                    ...
                    <form
                        action="{{ isset($offer) ? route('admin.offers.update', $offer) : route('admin.offers.store') }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="md:col-span-2">
                                <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Offer
                                    Title</label>
                            ...
                            <!-- Subtitle -->
                            <div class="md:col-span-2">
                                <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Subtitle /
                                    Description</label>
                            ...
                            <!-- Discount Code -->
                            <div>
                                <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Discount
                                    Code (Optional)</label>
                                <input type="text" name="discount_code"
                                    value="{{ old('discount_code', $offer->discount_code ?? '') }}"
                                ...
                                @error('discount_code') <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>

                            <!-- Valid Until -->
                            <div>
                                <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Valid
                                    Until</label>
                                <input type="datetime-local" name="valid_until"
                                    value="{{ old('valid_until', isset($offer) && $offer->valid_until ? \Carbon\Carbon::parse($offer->valid_until)->format('Y-m-d\TH:i') : '') }}"
                                    class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white rounded-2xl focus:ring-indigo-500 focus:border-indigo-500 block p-4 shadow-sm transition">
                            ...
                            <div class="md:col-span-2">
                                ...
                                @if(isset($offer) && $offer->image_url)
                                    <div class="mt-4">
                                        ...
                                        <img src="{{ Str::startsWith($offer->image_url, 'http') ? $offer->image_url : asset($offer->image_url) }}"
                            ...
                            <div class="md:col-span-2 flex items-center mt-4">
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="is_active" value="1" class="sr-only peer" {{ old('is_active', $offer->is_active ?? true) ? 'checked' : '' }}>
                                    <div
