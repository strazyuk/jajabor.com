                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 dark:text-gray-400 font-medium mt-1">
                                {{ isset($package) ? 'Update travel package details.' : 'Add a new travel package.' }}
                            </p>
                        </div>
                    </div>
                </header>
                    ...
                    <form
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="md:col-span-2">
                                <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Package
                                    Title</label>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" rows="4" required
                                    class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white rounded-2xl focus:ring-indigo-500 focus:border-indigo-500 block p-4 shadow-sm transition">{{ old('description', $package->description ?? '') }}</textarea>
                            ...
                            <!-- Duration -->
                            <div>
                                <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Duration
                                    (Days)</label>
                                ...
                                @if(isset($package) && $package->image_url)
                                    <div class="mt-4">
                                        ...
                                        <img src="{{ Str::startsWith($package->image_url, 'http') ? $package->image_url : asset($package->image_url) }}"
                                            class="h-32 w-48 object-cover rounded-lg border border-gray-200 shadow-sm">
                                    </div>
                                @endif
